# fresh_celebrity_start.py
# Complete fresh start - সব delete করে clean slate
...
print("\n" + "="*70)
print("🗑️  FRESH START - CLEANING ALL CELEBRITY DATA")
print("="*70)
print("\n⚠️  WARNING: This will delete all celebrity data!")
...
bucket = "celebrity-lookalike-celebrity-lookalike"
collection = "celebrity_image_collections"
table_name = "celebrity-dynamo-table"
...
# 3. Delete all S3 images in celebritybucket folder
print("\n3️⃣ Cleaning S3 Bucket...")
try:
    paginator = aws.s3_client.get_paginator('list_objects_v2')
    pages = paginator.paginate(Bucket=bucket, Prefix="celebritybucket/")
...
s3_keys = aws.debug_s3_keys(bucket, "celebritybucket")
...
print("\n💡 Next Steps:")
print("   1. Upload celebrity images using /celebrity/add endpoint")
